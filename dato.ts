...
export type EmployeeModelOrderBy =
  | "_createdAt_ASC"
  | "_createdAt_DESC"
  ...
  query Employees {
    allEmployees {
      ...
      profilePicture {
        alt
        responsiveImage(
          imgixParams: { fit: crop, w: 960, h: 960, auto: format }
        ) {
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    Employees(
      ...
      return requester<EmployeesQuery, EmployeesQueryVariables>(
        EmployeesDocument,
        variables,
        options
      ) as Promise<EmployeesQuery>;
    },
  };
}
